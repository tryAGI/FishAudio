...
namespace FishAudio
{
    public partial class OpenAPIV1Client
    {
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement s_CreateTtsSecurityRequirement0 =
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement[] s_CreateTtsSecurityRequirements =
            new global::FishAudio.EndPointSecurityRequirement[]
                ...
                else
                {
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::FishAudio.CreateTtsResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::FishAudio.CreateTtsResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.CreateTtsResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 402)
                            {
                                ...
                                global::FishAudio.CreateTtsResponse2? __value_402 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_402 = global::FishAudio.CreateTtsResponse2.FromJson(__content_402, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.CreateTtsResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::System.Collections.Generic.IList<global::FishAudio.CreateTtsResponseItem>? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = (global::System.Collections.Generic.IList<global::FishAudio.CreateTtsResponseItem>?)global::System.Text.Json.JsonSerializer.Deserialize(__content_422, typeof(global::System.Collections.Generic.IList<global::FishAudio.CreateTtsResponseItem>), JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::System.Collections.Generic.IList<global::FishAudio.CreateTtsResponseItem>>.Create(
                                    statusCode: __response.StatusCode,
