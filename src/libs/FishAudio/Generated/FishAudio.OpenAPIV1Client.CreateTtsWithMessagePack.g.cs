...
namespace FishAudio
{
    public partial class OpenAPIV1Client
    {
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement s_CreateTtsWithMessagePackSecurityRequirement0 =
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement[] s_CreateTtsWithMessagePackSecurityRequirements =
            new global::FishAudio.EndPointSecurityRequirement[]
        ...
        ///   }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::FishAudio.AutoSDKHttpResponse> CreateTtsWithMessagePackAsResponseAsync(
                ...
                else
                {
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::FishAudio.CreateTtsResponse3? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::FishAudio.CreateTtsResponse3.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.CreateTtsResponse3>.Create(
                                    statusCode: __response.StatusCode,
