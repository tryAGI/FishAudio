...
namespace FishAudio
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::FishAudio.AutoSDKRetryOptions Retry { get; set; } = new global::FishAudio.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::FishAudio.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::FishAudio.IAutoSDKHook>();
        ...
        public global::FishAudio.AutoSDKClientOptions AddHook(
            global::FishAudio.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::FishAudio.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::FishAudio.AutoSDKClientOptions UseAuthorizationProvider(
            global::FishAudio.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::FishAudio.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::FishAudio.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::FishAudio.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::FishAudio.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::FishAudio.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::FishAudio.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::FishAudio.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::FishAudio.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::FishAudio.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::FishAudio.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::FishAudio.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::FishAudio.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::FishAudio.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::FishAudio.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::FishAudio.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::FishAudio.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::FishAudio.AutoSDKClientOptions clientOptions,
            global::FishAudio.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::FishAudio.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::FishAudio.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::FishAudio.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::FishAudio.AutoSDKClientOptions clientOptions,
            global::System.Func<global::FishAudio.IAutoSDKHook, global::FishAudio.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::FishAudio.AutoSDKHookContext context)
        {
