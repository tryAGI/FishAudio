...
namespace FishAudio
{
    public partial class AgentSessionsClient
    {
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement s_GetAgentSessionsBySessionIdRecordingSecurityRequirement0 =
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement[] s_GetAgentSessionsBySessionIdRecordingSecurityRequirements =
            new global::FishAudio.EndPointSecurityRequirement[]
            {                s_GetAgentSessionsBySessionIdRecordingSecurityRequirement0,
            };
        partial void PrepareGetAgentSessionsBySessionIdRecordingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId);
        partial void PrepareGetAgentSessionsBySessionIdRecordingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId);
        partial void ProcessGetAgentSessionsBySessionIdRecordingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAgentSessionsBySessionIdRecordingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::FishAudio.GetAgentSessionsRecordingResponse> GetAgentSessionsBySessionIdRecordingAsync(
            string sessionId,
            global::FishAudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAgentSessionsBySessionIdRecordingAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::FishAudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::FishAudio.AutoSDKHttpResponse<global::FishAudio.GetAgentSessionsRecordingResponse>> GetAgentSessionsBySessionIdRecordingAsResponseAsync(
            string sessionId,
            global::FishAudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAgentSessionsBySessionIdRecordingArguments(
            ...
            var __authorizations = global::FishAudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAgentSessionsBySessionIdRecordingSecurityRequirements,
                operationName: "GetAgentSessionsBySessionIdRecordingAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::FishAudio.PathBuilder(
                                path: $"/v1/agent/sessions/{sessionId}/recording",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAgentSessionsBySessionIdRecordingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::FishAudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAgentSessionsBySessionIdRecording",
                                methodName: "GetAgentSessionsBySessionIdRecordingAsync",
                                pathTemplate: "$\"/v1/agent/sessions/{sessionId}/recording\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAgentSessionsBySessionIdRecordingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::FishAudio.GetAgentSessionsRecordingResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::FishAudio.GetAgentSessionsRecordingResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.GetAgentSessionsRecordingResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::FishAudio.GetAgentSessionsRecordingResponse3? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::FishAudio.GetAgentSessionsRecordingResponse3.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.GetAgentSessionsRecordingResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAgentSessionsBySessionIdRecordingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::FishAudio.GetAgentSessionsRecordingResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::FishAudio.AutoSDKHttpResponse<global::FishAudio.GetAgentSessionsRecordingResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::FishAudio.GetAgentSessionsRecordingResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
