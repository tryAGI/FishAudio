...
namespace FishAudio
{
    public partial class AgentsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::FishAudio.GetAgentAgentsVersionsResponse5> GetAgentAgentsByAgentIdVersionsByVersionNumberAsync(
            string agentId,
            int versionNumber,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::FishAudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::FishAudio.AutoSDKHttpResponse<global::FishAudio.GetAgentAgentsVersionsResponse5>> GetAgentAgentsByAgentIdVersionsByVersionNumberAsResponseAsync(
            string agentId,
            int versionNumber,
            global::FishAudio.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                else
                {
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::FishAudio.GetAgentAgentsVersionsResponse6? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::FishAudio.GetAgentAgentsVersionsResponse6.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.GetAgentAgentsVersionsResponse6>.Create(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::FishAudio.GetAgentAgentsVersionsResponse7? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::FishAudio.GetAgentAgentsVersionsResponse7.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::FishAudio.GetAgentAgentsVersionsResponse5.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::FishAudio.AutoSDKHttpResponse<global::FishAudio.GetAgentAgentsVersionsResponse5>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::FishAudio.GetAgentAgentsVersionsResponse5.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
