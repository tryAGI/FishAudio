...
namespace FishAudio
{
    ...
    public sealed partial class CreateModelRequest3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::FishAudio.JsonConverters.CreateModelRequestVisibility3JsonConverter))]
        public global::FishAudio.CreateModelRequestVisibility3? Visibility { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateModelRequest3" /> class.
        /// </summary>
        /// <param name="title">
        /// Model title or name
        /// </param>
...
#endif
        public CreateModelRequest3(
            string title,
            global::FishAudio.AnyOf<global::System.Collections.Generic.IList<byte[]>, byte[]> voices,
            global::FishAudio.CreateModelRequestVisibility3? visibility,
            string? description,
            byte[]? coverImage,
