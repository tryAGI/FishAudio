...
namespace FishAudio
{
    public partial interface IWalletClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::FishAudio.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::FishAudio.AutoSDKHttpResponse<global::FishAudio.GetWalletApiCreditResponse>> GetWalletByUserIdApiCreditAsResponseAsync(
            string? userId,
            bool? checkFreeCredit = default,
            string? teamId = default,
            global::FishAudio.AutoSDKRequestOptions? requestOptions = default,
