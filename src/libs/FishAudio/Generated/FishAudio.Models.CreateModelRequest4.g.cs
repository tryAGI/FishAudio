...
namespace FishAudio
{
    ...
    public sealed partial class CreateModelRequest4
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::FishAudio.JsonConverters.CreateModelRequestVisibility4JsonConverter))]
        public global::FishAudio.CreateModelRequestVisibility4? Visibility { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateModelRequest4" /> class.
        /// </summary>
        /// <param name="title">
        /// Model title or name
        /// </param>
...
#endif
        public CreateModelRequest4(
            string title,
            global::FishAudio.AnyOf<global::System.Collections.Generic.IList<byte[]>, byte[]> voices,
            global::FishAudio.CreateModelRequestVisibility4? visibility,
            string? description,
            byte[]? coverImage,
