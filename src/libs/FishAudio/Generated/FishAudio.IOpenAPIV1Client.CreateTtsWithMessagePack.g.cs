...
namespace FishAudio
{
    public partial interface IOpenAPIV1Client
    {
        ...
        ///   }'
        /// </remarks>
        global::System.Threading.Tasks.Task CreateTtsWithMessagePackAsync(
        ...
        ///   }'
        /// </remarks>
        global::System.Threading.Tasks.Task<global::FishAudio.AutoSDKHttpResponse> CreateTtsWithMessagePackAsResponseAsync(
