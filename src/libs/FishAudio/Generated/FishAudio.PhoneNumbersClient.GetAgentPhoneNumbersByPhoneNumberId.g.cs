...
namespace FishAudio
{
    public partial class PhoneNumbersClient
    {
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement s_GetAgentPhoneNumbersByPhoneNumberIdSecurityRequirement0 =
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement[] s_GetAgentPhoneNumbersByPhoneNumberIdSecurityRequirements =
            new global::FishAudio.EndPointSecurityRequirement[]
            {                s_GetAgentPhoneNumbersByPhoneNumberIdSecurityRequirement0,
            };
        partial void PrepareGetAgentPhoneNumbersByPhoneNumberIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string phoneNumberId);
        partial void PrepareGetAgentPhoneNumbersByPhoneNumberIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string phoneNumberId);
        partial void ProcessGetAgentPhoneNumbersByPhoneNumberIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAgentPhoneNumbersByPhoneNumberIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetAgentPhoneNumbersByPhoneNumberIdAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAgentPhoneNumbersByPhoneNumberIdArguments(
            ...
            var __authorizations = global::FishAudio.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAgentPhoneNumbersByPhoneNumberIdSecurityRequirements,
                operationName: "GetAgentPhoneNumbersByPhoneNumberIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAgentPhoneNumbersByPhoneNumberIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::FishAudio.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAgentPhoneNumbersByPhoneNumberId",
                                methodName: "GetAgentPhoneNumbersByPhoneNumberIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAgentPhoneNumbersByPhoneNumberIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAgentPhoneNumbersByPhoneNumberIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
