...
namespace FishAudio
{
    public partial class ModelClient
    {
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement s_CreateModelSecurityRequirement0 =
        ...
        private static readonly global::FishAudio.EndPointSecurityRequirement[] s_CreateModelSecurityRequirements =
            new global::FishAudio.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::FishAudio.CreateModelResponse> CreateModelAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::FishAudio.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::FishAudio.AutoSDKHttpResponse<global::FishAudio.CreateModelResponse>> CreateModelAsResponseAsync(
                    ...
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Visibility != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.Visibility).HasValue ? (request.Visibility).GetValueOrDefault().ToValueString() : string.Empty),
                                    name: "\"visibility\"");
                            ...
                            if (request.TrainMode != "fast")
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.TrainMode ?? string.Empty),
                                    name: "\"train_mode\"");
                            ...
                            if (request.EnhanceAudioQuality != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.EnhanceAudioQuality, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"enhance_audio_quality\"");

                            }
                            if (request.GenerateSample != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.GenerateSample, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                ...
                else
                {
                    await global::FishAudio.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::FishAudio.CreateModelResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::FishAudio.CreateModelResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.CreateModelResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                global::FishAudio.CreateModelResponse3? __value_503 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_503 = global::FishAudio.CreateModelResponse3.FromJson(__content_503, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_503 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::FishAudio.ApiException<global::FishAudio.CreateModelResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::FishAudio.CreateModelResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::FishAudio.AutoSDKHttpResponse<global::FishAudio.CreateModelResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::FishAudio.CreateModelResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::FishAudio.CreateModelResponse> CreateModelAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::FishAudio.CreateModelRequest3
            {
