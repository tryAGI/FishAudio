...
namespace FishAudio.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "FishAudio.CLI";
    private const string UserSecretApiKeyName = "FISHAUDIO_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"FISHAUDIO_API_KEY"];
    private const string CredentialFileDirectoryName = ".fish-audio";

    public static async global::System.Threading.Tasks.Task<global::FishAudio.FishAudioClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::FishAudio.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::FishAudio.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::FishAudio.FishAudioClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::FishAudio.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::FishAudio.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::FishAudio.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::FishAudio.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("FISHAUDIO_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::FishAudio.ApiException exception)
    {
        var builder = new StringBuilder();
