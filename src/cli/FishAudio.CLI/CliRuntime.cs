...
internal static class CliRuntime
{
    ...
    public static async Task<global::FishAudio.FishAudioClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::FishAudio.ApiException exception)
    {
        var builder = new StringBuilder();
