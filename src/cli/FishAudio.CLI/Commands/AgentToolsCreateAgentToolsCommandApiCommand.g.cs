...
internal static partial class AgentToolsCreateAgentToolsCommandApiCommand
{
    ...
    private static Option<global::FishAudio.PublicAgentToolCreatePayloadToolType?> ToolType { get; } = new(
        name: @"--tool-type")
    {
        Description = @"",
    };
    ...
    private static Option<global::FishAudio.PublicAgentToolCreatePayloadMethod?> Method { get; } = new(
        name: @"--method")
    {
        Description = @"",
    };
    ...
    private static Option<global::FishAudio.PublicAgentToolCreatePayloadErrorHandling?> ErrorHandling { get; } = new(
        name: @"--error-handling")
    {
        Description = @"",
    };
    ...
    private static Option<bool?> ExpectsResponse { get; } = CliRuntime.CreateNullableBoolOption(
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::FishAudio.CreateAgentToolsResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::FishAudio.CreateAgentToolsResponse value, ref string? text);
...
authorization_basic) are write-only and read back as `has_secret`.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::FishAudio.PublicAgentToolCreatePayload>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var toolType = CliRuntime.WasSpecified(parseResult, ToolType) ? parseResult.GetValue(ToolType) : (__requestBase is { } __ToolTypeBaseValue ? __ToolTypeBaseValue.ToolType : default);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.AgentTools.CreateAgentToolsAsync(
                                    name: name,
