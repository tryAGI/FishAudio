...
internal static partial class OpenAPIV1CreateTtsStreamWithTimestampCommandApiCommand
{
        ...
        name: @"--model")
    {
        ...
        DefaultValueFactory = _ => global::FishAudio.CreateTtsStreamWithTimestampModel.S21ProFree,
    };
    ...
    private static Option<global::FishAudio.TTSStreamWithTimestampRequestFormat?> Format { get; } = new(
        name: @"--format")
    {
    ...
    private static Option<global::FishAudio.TTSStreamWithTimestampRequestLatency?> Latency { get; } = new(
        name: @"--latency")
    {
