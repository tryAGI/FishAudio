...
internal static partial class KnowledgeSourcesCreateAgentKnowledgeSourcesCommandApiCommand
{
        ...
        name: @"--description")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::FishAudio.CreateAgentKnowledgeSourcesResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::FishAudio.CreateAgentKnowledgeSourcesResponse value, ref string? text);
...
`knowledge_base.knowledge_source_ids`.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::FishAudio.CreateAgentKnowledgeSourcesRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                        ...
                        var sourcename = parseResult.GetRequiredValue(Sourcename);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.KnowledgeSources.CreateAgentKnowledgeSourcesAsync(
                                    source: source,
