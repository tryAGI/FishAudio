...
internal static partial class KnowledgeSourcesGetAgentKnowledgeSourcesBySourceIdCommandApiCommand
{
        ...
        name: @"source-id")
    {
        Description = @"",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::FishAudio.GetAgentKnowledgeSourcesResponse4 value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::FishAudio.GetAgentKnowledgeSourcesResponse4 value, ref string? text);
